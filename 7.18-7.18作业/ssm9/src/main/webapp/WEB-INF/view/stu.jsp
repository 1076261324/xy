...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="stuName" class="form-control" id="txt_search_username" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="stuSid" id = "txt_search_roleid">
						...
						<c:forEach items="${slist }" var="s">
						 	<option value="${s.stuId }">${s.student }</option>
						</c:forEach>
                	</select>
				</div>
			 </div>
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            stuName: $("#txt_search_username").val(),
	...
	function initEditUser(getSelection){
		...
		$('#stuName').val(getSelection.stuName);
